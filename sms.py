...
def export_data():
     ...
     table=pandas.DataFrame(newList,columns=['Id','Name','Mobile','Email','Address','Gender','DOB','Added Date','Added Time'])    #in table form data
...
def connect_database():
    ...
    def connect():
         global mycursor,con
         try:
            con= pymysql.connect(host='localhost',user='root',password='shivam')
            mycursor=con.cursor()
         except:
    ...
    hostnameLabel=Label(connectWindow,text='Host Name',font=('arial'
                        ,20,'bold'))
    ...
    usernameLabel=Label(connectWindow,text='User Name',font=('arial'
                        ,20,'bold'))
    ...
    passwordLabel=Label(connectWindow,text='Password',font=('arial'
                        ,20,'bold'))
...
connectButton=ttk.Button(root,text='Connect databse',command=connect_database)
